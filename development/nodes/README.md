...
For future building reference, the pin layout of the mDot model used is avaiable <a href="https://github.com/OtagoPolytechnic/DunedinIoT/blob/gh-pages/development/nodes/mDot/mdot_pinout.png">here</a>
